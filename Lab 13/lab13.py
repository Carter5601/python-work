...
Y_train = np_utils.to_categorical(Y_train, 3) #now has dims (150, 4)

#Now to define the neural net structure and hyperparameters.

model = Sequential()
model.add(Dense(75, activation='relu',input_dim=4))
...
Y_validate = np_utils.to_categorical(Y_validate, 3)
...
testimagenumber = 15
singletest=X_validate[testimagenumber]
print(Y_validate[testimagenumber])
